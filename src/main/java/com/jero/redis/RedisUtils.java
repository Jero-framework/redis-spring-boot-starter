...
public class RedisUtils {
     ...
     * @param listKey
     * @param expireValue 有效期值
     * @param expireUnit 有效期单位
     * @param values 待添加的数据
     */
    public void addToListRight(String listKey, Long expireValue, TimeUnit expireUnit, Object... values) {
        //绑定操作
        BoundListOperations<String, Object> boundValueOperations = redisTemplate.boundListOps(listKey);
        //插入数据
        boundValueOperations.rightPushAll(values);
        //设置过期时间
        boundValueOperations.expire(expireValue, expireUnit);
    }
    /**
